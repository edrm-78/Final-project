...
top5_employment_2025 = top5_employment_2025.rename(
    columns={"name": "Country", "female_employment_rate": "Female employment rate"}
)
...
## 📁 Navigation  
- <i class="bi bi-house-door"></i> [Overview](#overview)
- <i class="bi bi-people"></i> [Fertility](#fertility)
- <i class="bi bi-person-workspace"></i> [Female Employment](#female-employment-rate)
- <i class="bi bi-diagram-3"></i> [Fertility & Employment](#fertility--female-employment)
- <i class="bi bi-journal-text"></i> [Further Information](#further-information)
- <i class="bi bi-lightbulb"></i> [Summary](#overall-summary)

## 📥 Downloads  
- <i class="bi bi-file-earmark-arrow-down"></i> [Fertility data](fertility_data_2000_2025.csv)
- <i class="bi bi-file-earmark-arrow-down"></i> [Female employment data](female_employment_2000_2025.csv)
- <i class="bi bi-file-earmark-arrow-down"></i> [Merged dataset](fert_emp_combined.csv)
...
- <i class="bi bi-bar-chart"></i> Across OECD countries, the long-run association between female employment and fertility is predominantly negative.

- <i class="bi bi-globe"></i> In developing countries, the relationship is also mostly negative, though shaped by wider institutional and socio-economic factors.

- <i class="bi bi-sliders2"></i> The relationship depends not only on labour supply but also on policy environments, childcare provision, labour-market structures and gender norms.

- <i class="bi bi-graph-down-arrow"></i> Fertility converges downward over time, while female employment evolves more gradually and remains strongly influenced by regional and institutional differences.
